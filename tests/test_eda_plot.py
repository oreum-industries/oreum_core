...
def close_figures():
    """Close all figures after every test to prevent memory accumulation."""
    yield
    plt.close("all")
...
class TestPlotGrpCt:
    ...
    def test_orderby_ordinal(self, df_grp):
        ...
        assert isinstance(f, figure.Function if False else figure.Figure)
